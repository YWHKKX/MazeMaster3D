...
func set_basic_config(building_name: String, building_width: int = 3, building_depth: int = 3, building_height: int = 3):
	"""设置基础配置"""
	name = building_name
...
func set_material_config(wall: Color = Color.WHITE, roof: Color = Color.RED, floor: Color = Color.GRAY, window: Color = Color.LIGHT_BLUE, door: Color = Color.BROWN):
	"""设置材质配置"""
	wall_color = wall
	roof_color = roof
	floor_color = floor
